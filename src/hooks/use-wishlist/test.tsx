...
describe('useWishlist', () => {
  ...
  it('should verify items in wishlist', async () => {
    const wrapper = ({ children }: { children: React.ReactNode }) => (
      <MockedProvider mocks={[wishlistMock]}>
        <WishlistProvider>{children}</WishlistProvider>
      </MockedProvider>
  ...
  it('should add item in wishlist creating a new wishlist', async () => {
    const wrapper = ({ children }: { children: React.ReactNode }) => (
  ...
  it('should add item updating the current wishlist', async () => {
    const wrapper = ({ children }: { children: React.ReactNode }) => (
